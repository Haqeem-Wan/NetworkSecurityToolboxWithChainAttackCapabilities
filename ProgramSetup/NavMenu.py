...
class NavMenu:
    def __init__ (self, root, headerFrame, navMenuFrame, contentFrame):
        ...
        self.closedNavMenuImg = PIL.Image.open("/home/haqeem/Desktop/fypCode/NetworkSecurityToolboxWithChainAttackCapabilities/img/Closed_Box.png")
        self.openNavMenuImg = PIL.Image.open("/home/haqeem/Desktop/fypCode/NetworkSecurityToolboxWithChainAttackCapabilities/img/Open_Box.png")
