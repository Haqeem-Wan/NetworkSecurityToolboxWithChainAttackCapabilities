...
class PageLayer2Attacks:
    def __init__ (self, frame):
        ...
        self.camButton = Button(self.navLayer2Frame, height=100, width = 19, font="BahnschriftLight 12", bg="#333333", fg="#ffffff", 
                                activebackground="#333333", activeforeground="#9e9e9e", highlightthickness=0, bd=0, borderwidth=3,relief="raised")
        self.vlanButton = Button(self.navLayer2Frame, height=100, width = 19, font="BahnschriftLight 12", bg="#333333", fg="#ffffff", 
                                activebackground="#333333", activeforeground="#9e9e9e", highlightthickness=0, bd=0, borderwidth=3,relief="raised")
        self.arpButton = Button(self.navLayer2Frame, height=100, width = 19, font="BahnschriftLight 12", bg="#333333", fg="#ffffff", 
                                activebackground="#333333", activeforeground="#9e9e9e", highlightthickness=0, bd=0, borderwidth=3,relief="raised")
        self.dhcpButton = Button(self.navLayer2Frame, height=100, width = 19, font="BahnschriftLight 12", bg="#333333", fg="#ffffff", 
                                activebackground="#333333", activeforeground="#9e9e9e", highlightthickness=0, bd=0, borderwidth=3,relief="raised")
        self.macButton = Button(self.navLayer2Frame, height=100, width = 19, font="BahnschriftLight 12", bg="#333333", fg="#ffffff", 
                                activebackground="#333333", activeforeground="#9e9e9e", highlightthickness=0, bd=0, borderwidth=3,relief="raised")
        self.stpButton = Button(self.navLayer2Frame, height=100, width = 19, font="BahnschriftLight 12", bg="#333333", fg="#ffffff", 
                                activebackground="#333333", activeforeground="#9e9e9e", highlightthickness=0, bd=0, borderwidth=3,relief="raised")
