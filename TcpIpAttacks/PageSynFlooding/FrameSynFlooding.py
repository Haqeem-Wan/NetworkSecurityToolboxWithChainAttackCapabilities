...
class FrameSynFlooding:
    ...
    def switch_button_mode(self, whichButton) :
        ...
        if(whichButton == "Start") :
            ...
            startSynFlood(self.targetIpEntry.get(), self.targetPortEntry.get(), self.terminalContentFrame, self.wiresharkContentFrame, self.errorOutputContentFrame)
