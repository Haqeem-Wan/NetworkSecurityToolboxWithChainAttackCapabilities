...
class PageTcpIpAttacks:
    def __init__ (self, frame):
        ...
        self.navTcpIpFrame = Frame(self.tcpIpFrame, width=1280, height=40, background="#454545")
        self.attackFrame = Frame(self.tcpIpFrame, width=1280, height=580, background="#454545")
        ...
        for i in range(len(self.navTcpIpOptions)):
            button = Button(self.navTcpIpFrame, text=self.navTcpIpOptions[i], height=100, width = 19, font="BahnschriftLight 12", bg="#333333", fg="#ffffff", 
    ...
    def showFrameIpSpoofing(self) :
        self.deletePages()
        self.ipSpoofingFrame = Frame(self.attackFrame, width=1280, height=580, background="#454545")
        self.ipSpoofingContents = FrameIpSpoofing(self.attackFrame)
        self.ipSpoofingFrame.pack()
    
    def showFrameSslStrip(self) :
        self.deletePages()
        self.sslStripFrame = Frame(self.attackFrame, width=1280, height=580, background="#454545")
