...
class FrameSslStrip:
    def __init__ (self, frame):
        ...
        self.targetIpEntry = Entry(self.attackFrame, width = 40, font="bahnschrift 15", fg="#ffffff", bg="#1A3329")
        self.targetIpEntry.place(x = 435, y = 45)

        self.targetDefaultGateLabel = Label(self.attackFrame,   text="Target Default Gateway   :", fg="#ffffff", bg="#295543", font="bahnschrift 15")
        self.targetDefaultGateLabel.place(x = 85, y = 95)
        ...
        self.terminalFrame = Frame(self.attackFrame, width=500, height=260, background="#1A3329", highlightbackground="#ffffff", highlightthickness=2)
        self.terminalFrame.pack_propagate(False)
        self.terminalFrame.place(x = 90, y = 210)

        self.terminalScrollCanvas = Canvas(self.terminalFrame, background="#1A3329", highlightbackground="#ffffff", yscrollincrement=8)
        ...
        self.terminalContentFrame = Frame(self.terminalScrollCanvas, background="#1A3329", highlightbackground="#ffffff")
        ...
        self.wiresharkFrame = Frame(self.attackFrame, width=500, height=260, background="#1A3329", highlightbackground="#ffffff", highlightthickness=2)
        self.wiresharkFrame.pack_propagate(False)
        self.wiresharkFrame.place(x = 690, y = 210)

        self.wiresharkScrollCanvas = Canvas(self.wiresharkFrame, background="#1A3329", highlightbackground="#ffffff", yscrollincrement=8)
        ...
        self.wiresharkContentFrame = Frame(self.wiresharkScrollCanvas, background="#1A3329", highlightbackground="#ffffff")
        ...
        self.errorOutputFrame = Frame(self.attackFrame, width=500, height=100, background="#1A3329", highlightbackground="#ffffff", highlightthickness=2)
        self.errorOutputFrame.pack_propagate(False)
        self.errorOutputFrame.place(x = 390, y = 515)

        self.errorOutputScrollCanvas = Canvas(self.errorOutputFrame, background="#1A3329", highlightbackground="#ffffff", yscrollincrement=8)
        ...
        self.errorOutputContentFrame = Frame(self.errorOutputScrollCanvas, background="#295543", highlightbackground="#ffffff")
